...
from utils import get_capsule_mount_point, get_template_mount_point
...
class TerminalOps(BaseCommandRunner):
    ...
    def open_shared_directory(self, entity_type: Entity, name: str) -> CommandResult:
        ...
        path = get_capsule_mount_point(name) if entity_type == Entity.CAPSULE else get_template_mount_point(name)
